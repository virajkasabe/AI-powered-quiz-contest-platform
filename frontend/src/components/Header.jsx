...
const Header = () => {
  ...
  return (
    <header className="h-20 bg-white/70 dark:bg-slate-900/70 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 flex items-center justify-between px-8 z-10 sticky top-0 transition-colors">
      ...
      <div className="flex items-center gap-5">
        ...
        <button 
          onClick={toggleTheme}
          className="text-slate-400 dark:text-slate-400 hover:text-sky-500 dark:hover:text-sky-400 transition-colors w-10 h-10 rounded-full flex items-center justify-center hover:bg-sky-50/50 dark:hover:bg-slate-800"
          title="Toggle Theme"
        >
          {theme === 'dark' ? (
        ...
        <button className="text-slate-400 dark:text-slate-400 hover:text-sky-500 dark:hover:text-sky-400 transition-colors w-10 h-10 rounded-full flex items-center justify-center hover:bg-sky-50/50 dark:hover:bg-slate-800">
